...
class BLE_scanner:
    def __init__(self, ble, first_dev_log_filename):
      ...
      self.first_dev_log_filename_2 = first_dev_log_filename.replace(
        ".csv.", "(2).csv."
      )
      ...
      self.n = 0
      self.my_print(
        SCRIPT_NAME + " v. " + SCRIPT_VERSION + " [" + first_dev_log_filename + "]"
      )
    ...
    def my_print(self, tx):
      ...
      if self.first_dev_log_file_handler is None:
        try:
          ...
          #time.sleep(0.2)
          #self.first_dev_log_file_handler = open(self.first_dev_log_filename_2, "a")
          #self.first_dev_log_file_handler.write(tx + "\n")
          #self.first_dev_log_file_handler.close()
        except Exception as e:
      ...
      if self.uart is not None:
        try:
          ...
          self.my_print("my_print ERROR: to UART writting")
          self.my_print(e)
          self.uart = None
...
def work():
    ...
    first_dev_log_filename = first_dev_log_filename.replace(
